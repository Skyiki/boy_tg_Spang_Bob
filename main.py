...
def help_func(message):
    bot.send_message(chat_id=message.chat.id, text=f"Я умею: start - запуск бота."
                                                   "help - справочная информация о доступных командах и их "
                                                   "функциональности."
                                                   "hobby - рассказывает про свои увлечения, работу, хобби."
                                                   "aboutme - рассказывает про себя."
                     )
...
def help_func(message):
    bot.send_message(chat_id=message.chat.id, text=f'    Я обожаю ловить медуз с моим другом Патриком.'
